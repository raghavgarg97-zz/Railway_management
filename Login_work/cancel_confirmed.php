				...
				<div class="row">
					<div class="booking-form">
						...
						<?php
							...
							$sq='START TRANSACTION;SELECT * FROM BOOKING FOR UPDATE;SELECT * FROM RAILWAY_PATH FOR SHARE;SELECT * FROM STATIONS FOR SHARE;SELECT * FROM TRAIN_INFO FOR SHARE;SELECT * FROM OVERALL_WAITING FOR UPDATE';
							$mysqli->query($sq);
